<template >
  <div class="vx-col w-full mb-base" v-if="renderComponent">
    ...
    <!-- <edit-operator-data :isSidebarActive="addNewDataSidebar" :operator="ready_operatingunit" @closeSidebar="addNewDataSidebar = false" /> -->
    <vx-card>
        <vs-tabs>
            <vs-tab :label="$t('operator_data')">
               <div class="mt-3">
                 <vs-table pagination max-items="10" search :data="ready_operatingunits">
                    ...
                    <template slot="thead">
                      <vs-th sort-key="operating_unit">{{$t('operating_unit')}}</vs-th>
